...
namespace Capstone_Backend.Repositories.UserRepository
{
    public interface IUserRepository
    {
        ...
        Task<AppartmentGetDTO> GetAppartmentById(int apartmentId, string host);
        Task<List<ResponsesGetDTO>> GetUserResponses(string userId, string host);
        Task<int> GetNumberOfReservedApartmentsAsync();
        Task<int> GetNumberOfPropertiesForSaleAsync();
        Task<int> GetNumberOfPropertiesForRentAsync();
        Task<int> GetNumberOfUploadedApartmentsAsync();
